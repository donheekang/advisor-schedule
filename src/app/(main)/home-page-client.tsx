      ...
      <Section className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#FFE9D2] via-[#FFD5AE] to-[#FFC38A] px-6 py-16 md:px-12 md:py-20">
        ...
        <div className="relative max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              href="/pet-talker"
              className="rounded-xl bg-[#48B8D0] px-6 py-3 text-base font-bold text-white transition hover:bg-[#B28B84]"
            >
              🗣 펫토커 해보기
            </Link>
            <Link
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {features.map((feature) => (
            ...
            >
              ...
              <Link href={feature.href} className="mt-5 inline-flex text-sm font-semibold text-[#B28B84]">
                {feature.cta}
              </Link>
            </article>
          ))}
      ...
      <Section className="rounded-3xl bg-gradient-to-r from-[#48B8D0] via-[#FB923C] to-[#FDBA74] px-6 py-12 text-center text-white md:px-10">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            ...
            className="rounded-xl border border-white/60 px-5 py-3 font-bold text-white transition hover:bg-[#B28B84]"
          >
            Google Play 다운로드
          </Link>
        </div>
            ...
            return (
              <article key={item.question} className="rounded-2xl bg-white px-5 py-4 shadow-sm">
                ...
                >
                  ...
                  <span className="text-[#B28B84]">{isOpen ? '−' : '+'}</span>
                </button>
