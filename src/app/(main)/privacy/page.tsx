...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 pb-20 pt-28">
      <h1 className="mb-2 text-2xl font-extrabold text-[#1F2937] md:text-3xl">개인정보처리방침</h1>
      <p className="mb-8 text-sm text-[#94A3B8]">최종 수정일: 2026년 2월 17일</p>

      <div className="prose-sm space-y-8 text-[#4A5568]">
        
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">1. 수집하는 개인정보</h2>
          <p className="leading-relaxed">PetHealth+(이하 &quot;서비스&quot;)는 서비스 제공을 위해 다음 정보를 수집합니다.</p>
          <p className="mt-2 leading-relaxed"><strong className="text-[#1F2937]">필수 수집 항목:</strong> 소셜 로그인 시 제공되는 이메일, 이름(닉네임), 프로필 사진</p>
          <p className="mt-1 leading-relaxed"><strong className="text-[#1F2937]">선택 수집 항목:</strong> 반려동물 정보(종류, 품종, 나이, 체중), 증상 입력 내용, 진료비 검색 기록</p>
          <p className="mt-1 leading-relaxed"><strong className="text-[#1F2937]">자동 수집 항목:</strong> 접속 IP, 브라우저 종류, 서비스 이용 기록, 접속 일시</p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">2. 개인정보의 수집 및 이용 목적</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">3. 개인정보의 보유 및 이용 기간</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">4. 개인정보의 제3자 제공</h2>
          <p className="leading-relaxed">PetHealth+는 이용자의 동의 없이 개인정보를 제3자에게 제공하지 않습니다. 다만, 법령에 의해 요구되는 경우는 예외로 합니다.</p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">5. 개인정보의 처리 위탁</h2>
