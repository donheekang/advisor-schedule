  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pb-20 pt-28">
      ...
      <div className="prose-sm space-y-8 text-[#4A5568]">
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">제3조 (의료 면책)</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">제4조 (진료비 데이터 면책)</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">제5조 (회원가입 및 탈퇴)</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">제6조 (서비스 이용 제한)</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">제7조 (면책사항)</h2>
          <p className="leading-relaxed">서비스는 천재지변, 기간통신사업자의 서비스 중지 등 불가항력적 사유로 인한 서비스 중단에 대해 책임지지 않습니다.</p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">제8조 (준거법 및 관할)</h2>
          <p className="leading-relaxed">본 약관은 대한민국 법률에 따라 해석되며, 분쟁 발생 시 서울중앙지방법원을 제1심 관할법원으로 합니다.</p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#1F2937]">제9조 (약관의 변경)</h2>
