      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-3 rounded-3xl border border-[#0B3041]/[0.06] bg-white p-5 shadow-sm">
          ...
          <button
            onClick={handleApple}
            disabled={loading !== ''}
            className="flex w-full items-center justify-center gap-3 rounded-2xl bg-[#ff7a45] px-8 py-4 text-sm font-bold text-white shadow-[0_0_30px_rgba(255,122,69,0.3)] transition-all hover:-translate-y-0.5 hover:shadow-[0_0_50px_rgba(255,122,69,0.4)] disabled:opacity-50"
          >
            {loading === 'apple' ? (
        ...
        <Link
          href="/"
          className="mt-4 block w-full rounded-2xl border border-[#E5E8EB] bg-white py-3 text-center text-sm font-semibold text-[#8B95A1] transition-all hover:bg-[#F8FAFB] hover:text-[#191F28]"
        >
          로그인 없이 둘러보기
        </Link>

        <div className="mt-5 rounded-2xl bg-[#fffaf5] p-4 text-center ring-1 ring-black/5">
          <p className="text-sm font-semibold text-[#17191f]">앱에서 더 많은 기능을 만나보세요</p>
          <p className="mt-1 text-xs text-[#697182]">진료 기록 관리부터 맞춤 건강 분석까지</p>
          <div className="mt-3 flex items-center justify-center gap-2">
            <a
              href="https://apps.apple.com/app/id6744428830"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-xl bg-[#0B3041] px-4 py-2.5 text-xs font-semibold text-white transition hover:bg-[#0d3a4f]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-xl border border-black/10 bg-white px-4 py-2.5 text-xs font-semibold text-[#17191f] transition hover:bg-[#f8f4ef]"
            >
        ...
        <p className="mt-6 text-center text-xs text-[#6B7280]">
          로그인 시 <Link href="/terms" className="font-semibold text-[#ff7a45] transition-colors hover:text-[#e46333]">이용약관</Link> 및{' '}
          <Link href="/privacy" className="font-semibold text-[#ff7a45] transition-colors hover:text-[#e46333]">
            개인정보처리방침
          </Link>
          에 동의합니다.
        </p>
