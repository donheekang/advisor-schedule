              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-xl bg-white/10 px-5 py-3 text-sm font-bold text-white transition-all hover:-translate-y-0.5 hover:bg-white/15"
                  >
