  ...
  return (
    <>
      <AnimateOnScroll animation="fade-up" delay={sectionDelays[0]}>
        <section className="relative overflow-hidden bg-gradient-to-b from-[#FFF8F0] to-white pb-16 pt-28 md:pb-24 md:pt-36">
          <div className="mx-auto max-w-6xl px-4">
            <div className="text-center">
              <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#F97316]/10 px-4 py-2 text-sm font-medium text-[#F97316]">
                <span>🤖</span> AI 진료비 분석 서비스
              </div>
              <h1 className="mb-6 text-3xl font-extrabold leading-[1.3] text-[#1B2A4A] md:text-4xl md:leading-[1.3] lg:text-[3.5rem] lg:leading-[1.3]">
                증상만 입력하면
                <br />
              ...
              <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
                <a
                  href="/ai-care"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#F97316] px-8 py-4 text-base font-bold text-white shadow-lg shadow-orange-200 transition hover:bg-[#EA580C] sm:w-auto"
                >
                  ✨ AI 견적서 받기
                </a>
                <a
                  href="/cost-search"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl border-2 border-[#E2E8F0] bg-white px-8 py-4 text-base font-bold text-[#1B2A4A] transition hover:border-[#F97316] hover:text-[#F97316] sm:w-auto"
                >
                  🔍 진료비 검색
                </a>
              </div>
              <div className="mt-8 flex flex-wrap justify-center gap-6 text-sm text-[#64748B]">
                ...
                <span className="flex items-center gap-1.5">
                  <span className="h-2 w-2 rounded-full bg-blue-400"></span>30초 AI 분석
                </span>
                <span className="flex items-center gap-1.5">
                  <span className="h-2 w-2 rounded-full bg-[#F97316]"></span>전국 진료비 비교
                </span>
              </div>
            </div>
          </div>
      ...
      <AnimateOnScroll animation="fade-up" delay={sectionDelays[1]}>
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="mb-3 text-center text-2xl font-extrabold text-[#1B2A4A] md:text-3xl">이런 걸 할 수 있어요</h2>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <a href="/ai-care" className="flex h-full flex-col rounded-2xl bg-white p-6 shadow-sm transition hover:shadow-md">
                <div className="mb-4 h-1 w-16 rounded-full bg-[#F97316]"></div>
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-orange-50 text-2xl">✨</div>
                <h3 className="mb-2 text-lg font-bold text-[#1B2A4A]">AI 견적서</h3>
                <p className="mb-4 flex-1 text-sm leading-relaxed text-[#64748B]">
                  증상을 입력하면 AI가 예상 질환과 진료비 범위를 분석해드려요
                </p>
                <span className="mt-auto text-sm font-semibold text-[#F97316]">받아보기 →</span>
              </a>
              <a
                href="/cost-search"
                className="flex h-full flex-col rounded-2xl bg-white p-6 shadow-sm transition hover:shadow-md"
              >
                <div className="mb-4 h-1 w-16 rounded-full bg-blue-400"></div>
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-2xl">🔍</div>
                <h3 className="mb-2 text-lg font-bold text-[#1B2A4A]">진료비 검색</h3>
                <p className="mb-4 flex-1 text-sm leading-relaxed text-[#64748B]">
                  전국 평균과 비교해서 적정 가격을 확인하세요
                </p>
                <span className="mt-auto text-sm font-semibold text-[#F97316]">검색하기 →</span>
              </a>
              <a
                href="/pet-talker"
                className="flex h-full flex-col rounded-2xl bg-white p-6 shadow-sm transition hover:shadow-md"
              >
                <div className="mb-4 h-1 w-16 rounded-full bg-purple-400"></div>
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-purple-50 text-2xl">🐾</div>
                <h3 className="mb-2 text-lg font-bold text-[#1B2A4A]">펫토커</h3>
                <p className="mb-4 flex-1 text-sm leading-relaxed text-[#64748B]">
                  사진 한 장으로 우리 아이의 마음을 들어보세요
                </p>
                <span className="mt-auto text-sm font-semibold text-[#F97316]">해보기 →</span>
              </a>
            </div>
          </div>
        </section>
      ...
      <AnimateOnScroll animation="fade-up" delay={sectionDelays[0]}>
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-6xl px-4">
            <h2 className="mb-4 text-center text-2xl font-extrabold text-[#1B2A4A] md:text-3xl">이런 점이 다릅니다</h2>
            <p className="mb-10 text-center text-sm text-[#64748B]">PetHealth+만의 차별점</p>
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="rounded-2xl bg-[#1B2A4A] p-8 text-center text-white">
                <div className="mb-3 text-3xl">🤖</div>
                <div className="mb-2 text-xl font-bold text-[#F97316]">AI 진료비 분석</div>
                <p className="text-sm text-white/70">Claude AI가 증상을 분석하고 예상 진료비를 알려드려요</p>
              </div>
              <div className="rounded-2xl bg-[#1B2A4A] p-8 text-center text-white">
                <div className="mb-3 text-3xl">📊</div>
                <div className="mb-2 text-xl font-bold text-[#F97316]">전국 평균 비교</div>
                <p className="text-sm text-white/70">지역별 진료비 평균 데이터로 적정 가격을 확인하세요</p>
              </div>
              <div className="rounded-2xl bg-[#1B2A4A] p-8 text-center text-white">
                <div className="mb-3 text-3xl">💰</div>
                <div className="mb-2 text-xl font-bold text-[#F97316]">완전 무료</div>
      ...
      <section className="py-12">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <p className="text-lg font-semibold text-[#1B2A4A]">우리 아이 건강, 지금 바로 확인해보세요</p>
