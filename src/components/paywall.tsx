...
export default function Paywall({
  ...
  return (
    <section className="rounded-3xl bg-[#D4B8C0] p-6 ring-1 ring-[#F8C79F]/30">
      ...
      <div className="mt-5 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-[#F8C79F]/20">
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="mt-3 flex flex-col gap-2 sm:flex-row">
            ...
            <button
              type="submit"
              className="rounded-2xl bg-gradient-to-r from-[#48B8D0] to-[#FB923C] px-5 py-2.5 text-sm font-bold text-white shadow-md transition hover:shadow-lg active:scale-[0.98]"
            >
              출시 알림 신청
            </button>
          </form>
      ...
      <Link
        href="/premium"
        className="mt-4 inline-flex text-sm font-bold text-[#48B8D0] hover:underline"
      >
        프리미엄 요금제 자세히 보기 →
      </Link>
    </section>
